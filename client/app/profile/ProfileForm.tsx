...
import { updateUserProfile, deleteAccount } from "../profile-actions";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Button } from "@/components/ui/button";
import Image from "next/image";
import { Facebook, Instagram, Music2, CheckCircle2, Loader2, Camera, User, Phone as PhoneIcon, Pencil, X as CancelIcon, Trash2 } from "lucide-react";
    ...
    return (
        <>
            <form ref={formRef} action={handleSubmit} className="p-10 space-y-10 relative">
                ...
                <div className="border border-red-100 rounded-2xl p-6 bg-red-50/30">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-xl font-black text-red-700">Danger Zone</h3>
                    </div>
                    <p className="text-sm text-gray-600 mb-5 font-medium">
                        Permanently delete your account and all associated data, including all your property listings, images, and social links.{' '}
                    ...
                    <Button
                        ...
                        disabled={isDeleting}
                        className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-2.5 rounded-xl shadow-sm transition-all active:scale-95 flex items-center gap-2"
                    >
                        {isDeleting ? (
            ...
            <ConfirmDialog
                ...
                description="This will permanently delete your account, all your property listings, and all associated data. This action cannot be undone."
